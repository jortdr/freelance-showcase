    ...
    <AuthenticatedLayout title="Update assignment">
        ...
        <div class="flex w-full flex-row h-[48rem]">
            <div class="w-1/3 border-r-2 mr-4">
                ...
                <Textarea :value="assignment.description" readonly style="resize:none;" class="w-full h-[50vh] border-0 m-0 p-5"/>
            ...
            <div class="w-2/3 h-full">
                <h1>Chat Window</h1>
                <ChatComponent :current-user="currentUser" :friend="receiver" class="h-full"/>
            </div>
        </div>
    </AuthenticatedLayout>
</template>
